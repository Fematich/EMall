...
def diffsign(cev1,cev2):
    ...
    print cev1['result']['precision'], cev1['result']['recall']
    print cev2['result']['precision'],cev2['result']['recall']
    if val<0:
        return True
    else:
        return False
...
if __name__ == "__main__":
    ...
    max_msim=sys.argv[4]
    if float(min_msim)==0:
        cev_min={"result":{"precision":0,"recall":1},"parameters":{"info":{"min_sim":0},"big":True}}
    else:
    ...
    if float(max_msim)==0.6:
        cev_max={"result":{"precision":1,"recall":0},"parameters":{"info":{"min_sim":0.6},"big":True}}
    else:
    ...
    if diffsign(cev_min,cev_new):
        ...
        print cev_max['parameters']['info']['min_sim']