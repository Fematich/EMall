...
#	do
#		cd $edir
#			event_name=$(echo $edir | cut -d "/" -f 6)
...
#			CMD="python /home/mfeys/work/EMall/evaluate.py $event_name splitname=$sname min_sim=$msim min_score=$mscore min_size=$msize evfile=$edir/aevents events_index=$edir/events_index dataset=event_mall"
#			echo $CMD; $CMD
#	done
#log_finish $INST
